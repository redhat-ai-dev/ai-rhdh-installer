...
3. Configuring GitOps/ArgoCD with the configuration script for a pre-existing ArgoCD and RHDH instance
4. Configuring GitOps/ArgoCD manually for a pre-existing ArgoCD and RHDH instance
